...
local VALIDATION_READER = "paraphrase-ref";
local CUDA = 0;
...

{
  ...
  "train_data_path": {
    "semantic": "tests/fixtures/paraphrase/semantic_samples.tsv",
    "syntactic": "tests/fixtures/paraphrase/syntactic_samples.tsv",
  },
  "validation_data_path": "tests/fixtures/paraphrase/dev_samples.tsv",
  "model": {
    "type": "info_vae",
    "task_encoder": {
      "type": "gaussian",
    ...
    "task_divergence": {"type": "cosine_distance", "use_mean_only": true},
    "gen_divergence": {"type": "cosine_distance", "use_mean_only": true},
