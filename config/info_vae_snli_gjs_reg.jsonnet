...
local TASK_PEN_WEIGHT = 10.0;
local GEN_PEN_WEIGHT = 10.0;
...

{
  ...
  "model": {
    ...
    "task_divergence": {"type": "generalized_js_divergence"},
    "gen_divergence": {"type": "generalized_js_divergence"},
    "task_margin": {"margin": 0.1, "smoothing": true},
    "gen_margin": {"margin": 0.1, "smoothing": true},
