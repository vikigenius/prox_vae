...
local TASK_LATENT_DIM = 4;
local GEN_LATENT_DIM = 28;
local BATCH_SIZE = 48;
local NUM_LAYERS = 1;
...

{
  ...
  "train_data_path": {
    "semantic": "data/interim/amazonsent/train_sent.tsv",
    "syntactic": "data/interim/amazonsent/train_cont.tsv",
  },
  "validation_data_path": {
    "semantic": "data/interim/amazonsent/valid_sent.tsv",
    "syntactic": "data/interim/amazonsent/valid_cont.tsv",
  },
  "model": {
    "type": "info_vae",
    "task_encoder": {
