...

{
  ...
  "train_data_path": {
    "semantic": "data/processed/paraphrase/semantic_sim_train.tsv",
    "syntactic": "data/processed/paraphrase/syntactic_sim_train.tsv",
  },
  "validation_data_path": "data/processed/paraphrase/dev.tsv",
  "model": {
    "type": "info_vae",
    "task_encoder": {
      "type": "gaussian",
